...
/**
 * Vista para consultar el requisito de un curso
 * @author Daniel Vaglio Fallas y Jafet Chavarria Moreno
 * @version Proyecto Programado I
 */
public class ConsultarCursosRequisito extends javax.swing.JFrame {
  public ConsultarCursosRequisito() {
    initComponents();
  ...
  public void llenarCbxListaCursos() {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Consultar Requisitos de un Curso");
        ...
        lblNombreEscuela1.setText("Requisitos del Curso");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarCursosRequisito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultarCursosRequisito().setVisible(true);
            }
        });
    }
